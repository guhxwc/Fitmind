  ...
  return (
    <OnboardingScreen>
      <div className="flex-grow flex flex-col justify-center items-center text-center relative px-6">
        ...
        {/* Background ambient glow - Made subtle for light mode visibility */}
        ...
        <h1 className="text-5xl font-extrabold text-gray-900 dark:text-white tracking-tight mb-4">FitMind</h1>
        <p className="text-gray-500 dark:text-gray-400 text-lg font-medium max-w-xs leading-relaxed">
            Seu copiloto inteligente na jornada com GLP-1.
        </p>
      </div>
