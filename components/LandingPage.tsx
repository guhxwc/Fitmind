                ...
                <div className="fm-hero-inner">
                    <div className="fm-hero-copy">
                        <div className="fm-pill">
                            <span className="fm-pill-dot" style={{ background: accent }}>
                                <span className="fm-pill-ping" style={{ background: accent }}></span>
                            </span>
                            <span>O Sistema #1 para usuários de GLP-1</span>
                        </div>
                        <h1 className="fm-h1">
                            Transforme seu tratamento em <span className="fm-h1-accent" style={{ color: accent }}>resultados reais</span>.
                        </h1>
                        <p className="fm-lede">
