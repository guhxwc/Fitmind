...
export const NOTIFICATIONS: AppNotification[] = [
  ...
  // ---------------------------------------------------------
  {
    ...
    type: 'modal',
    priority: 6,
    title: 'Sua assinatura acaba em 2 dias',
    body: 'Não perca seu acompanhamento. Indique 1 amigo que usa caneta emagrecedora e ganhe bônus exclusivos.',
    primaryAction: { label: 'Indicar amigo', action: 'share_referral' },
    secondaryAction: { label: 'Renovar agora', action: '/assinatura' },
  ...
  },
  {
    ...
    body: 'Não perca o acesso à sua evolução. Indique um amigo que usa medicação GLP-1 e confira as recompensas.',
    primaryAction: { label: 'Indicar Amigo', action: 'share_referral' },
    secondaryAction: { label: 'Renovar agora', action: '/assinatura' },
  ...
  },
  {
    ...
    body: 'Seus dados estão salvos. Renove agora por R$49/mês pra continuar seu acompanhamento na plataforma.',
    primaryAction: { label: 'Assinar R$49/mês', action: '/assinatura' },
    secondaryAction: { label: 'Indicar e ganhar bônus', action: 'share_referral' },
